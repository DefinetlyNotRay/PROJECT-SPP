...
<html lang="en">
  ...
  <body class="min-h-screen bg-blue-light">
    ...
    <div class="container flex w-96">
        <div class="flex ml-20 lg:ml-[35rem] w-[900px] justify-center flex-wrap -mx-4">
            <div class="px-4">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center flex items-center justify-center text-dark font-medium text-base py-5 px-2 bg-[#F3F6FF] border-b border-r border-[#E8E8E8]">
                                    <a href="./edit_page/pembayaran.php?id=<?php echo $row['id_pembayaran']; ?>" class="border border-blue-600 mr-2 py-2 px-6 text-blue-600 inline-block rounded hover:bg-blue-600 hover:text-white">
                                      Edit
                                    </a>
                                    <p>&nbsp;&nbsp;</p>
                                    <a href="./delete/pembayaran.php?id=<?php echo $row['id_pembayaran']; ?>" class="border border-red-700 py-2 px-6 text-red-700 inline-block rounded hover:bg-red-700 hover:text-white">
                                        Delete
                                    </a>
                                </td>
