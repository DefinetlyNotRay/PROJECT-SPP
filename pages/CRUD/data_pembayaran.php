...
<html lang="en">
  ...
  <body class="min-h-screen bg-blue-light">
    ...
    <nav class="fixed min-h-screen ">
      ...
      <div class="min-h-screen px-4 py-5 bg-blue-600 py-auto max-w-64">
        <ul class="flex flex-col h-screen gap-4 py-4 text-white text-m">
            <li><a class="px-5 text-2xl font-bold underline  " href="./data_pembayaran.php"><span class="sr-only">(current)</span>Data Pembayaran</a></li>
