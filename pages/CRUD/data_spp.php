    ...
    <div class="container ">
        <div class="flex flex-wrap justify-center">
            <div class="">
                ...
                <a href="./create_page/spp.php" class="inline-block px-6 py-2 mt-10 mb-5 mr-2 text-white bg-green-600 border border-green-600 rounded hover:border-white hover:text-white">
                         Add New Data
                     </a>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center flex items-center justify-center text-dark font-medium text-base py-5 px-2 bg-[#F3F6FF] border-b border-r border-[#E8E8E8]">
                                    <a href="./edit_page/spp.php?id=<?php echo $row['id_spp']; ?>" class="inline-block px-6 py-2 mr-2 text-blue-600 border border-blue-600 rounded hover:bg-blue-600 hover:text-white">
                                        Edit
                                    </a>
                                    <p>&nbsp;&nbsp;</p>
                                    <a href="./delete/spp.php?id=<?php echo $row['id_spp']; ?>" class="inline-block px-6 py-2 text-red-700 border border-red-700 rounded hover:bg-red-700 hover:text-white">
                                        Delete
                                    </a>
                                </td>
