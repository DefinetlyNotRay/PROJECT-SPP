...
<html lang="en">
  ...
  <nav class="fixed min-w-full">
      ...
      <div style="justify-content:space-between;" class="flex min-w-full px-4 py-5 bg-blue-600 py-auto w-fit">
        ...
        <li><a class="px-5 text-2xl font-bold underline" href="./entry.php">Entry Transaksi</a></li>
            ...
            <div class="">
                <div class="max-w-full" id="content">
                    ...
                    <?php 
                            ...
                            ?>
                    <p class="pb-3 text-3xl ">Nama: <?php echo $row["nisn"] ?></p>
                    <p class="pb-3 text-3xl ">Petugas: <?php echo $akun_data["nama"] ?></p>
                    <p class="pb-3 text-3xl ">Tanggal Bayar: <?php echo $row["tgl_bayar"] ?></p>
                    <?php 
                     
                    ?>
                    <p class="pb-3 text-3xl ">Bulan Bayar: <?php
                    require("../../../connection.php");
                     $no = 1;
                     $nisn = $_GET['nisn'];
                     $bulan_dibayar = $_GET['bulan_dibayar'];
                     ...
                     $query = mysqli_query($conn,"SELECT * FROM `data_pembayaran` WHERE tgl_bayar = '$tgl_bayar' AND nisn = '$nisn'");
                     while($row1 = mysqli_fetch_array($query)){ echo $row1["bulan_dibayar"]." "; } ?> <?php  ?></p>
                     
                    
                    <p class="pb-3 text-3xl ">Tahun Bayar: <?php echo $row["tahun_dibayar"] ?></p>
                    <p class="pb-3 text-3xl ">SPP: <?php echo $spp["tahun"]." | ".$spp["nominal"] ?></p>
                    <p class="pb-3 text-3xl ">Jumlah Bayar: <?php echo $row["jumlah_bayar"]*$totalRows?></p>
