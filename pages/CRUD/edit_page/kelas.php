    ...
    <div class="container ">
        <div class="flex flex-wrap justify-center">
            <div class="">
                ...
                <form action="../edit/kelas.php" method="POST">
                    <table class="w-[1440px] table-auto">
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    $no = 1;
                                    $id = $_GET["id"];
                                    $query = mysqli_query($conn,"SELECT * FROM `data_kelas` WHERE id_kelas = $id ");
                                ...
                                <input type="hidden" name="id" value="<?php echo $row["id_kelas"] ?>" />
                                    ...
                                    <td class="text-center text-dark font-medium text-base py-5 px-2 bg-[rgb(243,246,255)] border-b border-[#E8E8E8]">
                                        <input type="text" name="nama_kelas" class="max-w-[150px]" value="<?php echo $row["nama_kelas"] ?>" />
                                    </td>
                                    <td class="text-center text-dark font-medium text-base py-5 px-2 bg-white border-b border-[#E8E8E8]">
                                        <input type="text" name="kompetensi_keahlian" class="max-w-[150px]" value="<?php echo $row["kompetensi_keahlian"] ?>" />
                                    </td>
