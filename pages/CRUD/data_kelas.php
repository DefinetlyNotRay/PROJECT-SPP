                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center flex items-center justify-center text-dark font-medium text-base py-5 px-2 bg-[#F3F6FF] border-b border-r border-[#E8E8E8]">
                                    <a href="./edit_page/akun.php?id=<?php echo $row['id_kelas']; ?>" class="border border-blue-600 mr-2 py-2 px-6 text-blue-600 inline-block rounded hover:bg-blue-600 hover:text-white">
                                        Edit
                                    </a>
                                    <p>&nbsp;&nbsp;</p>
                                    <a href="./delete/akun.php?id=<?php echo $row['id_kelas']; ?>" class="border border-red-700 py-2 px-6 text-red-700 inline-block rounded hover:bg-red-700 hover:text-white">
                                        Delete
                                    </a>
                                </td>
