  ...
  <?php echo $successMessage ?>
        ...
        <div class="flex flex-wrap justify-center">
            <div class="">
                ...
                <a href="./create_page/akun.php" class="inline-block px-6 py-2 mt-10 mb-5 mr-2 text-white bg-green-600 border border-green-600 rounded hover:border-white hover:text-white">
                         Add New Data
                     </a>
